...
<body>
    ...
    <div class="login">
        ...
        <form class="login-form" action="login_process_maint.php" method="post">
          <!-- Input -->
          ...
          <a href = "admin_login.php"><button class="forget-password-button">Login as admin</button></a>
          <a href = "login.php"><button class="login-button">Login as a driver</button></a>
