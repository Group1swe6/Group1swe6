...
<body> 
    ...
    <main>
        <form> 
            ...
            <input type="text" id="startlocation" name="startlocation" placeholder="START LOCATION"> <br >
            <input type="text" id="endlocation" name="endlocation" placeholder="END LOCATION"> <br > 
            <input type="text" id="description" name="description" placeholder="DESCRIPTION"> <br > 
            <select id="status" name="status" placeholder="STATUS"> <br > 
            ...
            <input type="id" id="driverid" name="driverid" placeholder="DRIVER ID"> <br >
