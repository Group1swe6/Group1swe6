    ...
    <?php
            ...
            <form method="post" action="edit_route_process.php">
                        <input type="hidden" name="route_id" value="<?=$row['route_id']?>">
                            <p3 style="color:white;">Date:</p3> <input type="date" name="date_of_route" value="<?=$row['date_of_route']?>" required>
                            <p3 style="color:white;">Curr:</p3> <input type="text" name="curr_location" value="<?=$row['curr_location']?>" required>
                            <p3 style="color:white;">Start:</p3> <input type="text" name="start_location" value="<?=$row['start_location']?>" required>
                            <p3 style="color:white;">End:</p3> <input type="text" name="end_location" value="<?=$row['end_location']?>" required>
                            <p3 style="color:white;">Status:</p3> <input type="text" name="status_of_route" value="<?=$row['status_of_route']?>" required>
