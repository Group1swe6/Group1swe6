...
$result=$mysqli->query("select * from fuelingjob");
...
?>
    ...
    <main>
        ...
        <!-- Create table heading -->
            ...
            <?php
                while ($row=mysqli_fetch_array($result)){ 
                    echo "<tr><td>$row[fuel_job_id]</td>";
                    echo "<td>$row[date_of_job]</td>";
                    echo "<td>$row[fuel_amount]</td>";
                    echo "<td>$row[total_cost]</td>";
                    echo "<td>$row[description]</td>";
                    echo "<td>$row[station_name]</td>";
                    echo "<td>$row[vehicle_id]</td>";
                    echo "<td>$row[image_before]</td>";
                    echo "<td>$row[image_after]</td>";
                    echo "<td>$row[fuel_before]</td>";
                    echo "<td>$row[fuel_after]</td>";
                    echo "<td><a href='edit_tasks_fuelling.php?maint_job_id=$row[maint_job_id]'>Edit</a></td>";
                    echo "<td><a href='delete_tasks_fuelling.php?maint_job_id=$row[maint_job_id]'>Delete</a></td><tr>";
                } 
            ?>
        ...
        ?>
        <button class = "Button" onclick="window.location.href='tasksFuelForm.php'">Add Job
        </main> 
