...
<body>
    ...
    <main>
        <form method="post" action="add_auction.php" enctype="multipart/form-data">
            <input type="number" id="vehicle_id" name="vehicle_id" placeholder="VEHICLE ID"> <br>
            <select id="status" name="status" placeholder="STATUS OF AUCTION"> <br>
                ...
                <input type="file" id="images" name="images" accept="image/*" placeholder="Upload Images" multiple> <br>
                <button type="submit" name="submit" class="Button" value="Add Vehicle">Add Vehicle
        </form>
