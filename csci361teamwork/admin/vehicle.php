...
?>
    ...
    <main>
        ...
        <!-- Create table heading -->
            ...
            <?php
                while ($row=mysqli_fetch_array($result)){ 
                    ...
                    echo "<td>$row[year_of_vehicle]</td>";
                    echo "<td>$row[sitting_capacity]</td>";
                    echo "<td>$row[status_of_vehicle]</td>";
                    echo "<td>$row[milage]</td>";
                    echo "<td><a href='edit_vehicle.php?vehicle_id=$row[vehicle_id]'>Edit</a></td>";
                    echo "<td><a href='delete_vehicle.php?vehicle_id=$row[vehicle_id]'>Delete</a></td><tr>";
                } 
            ?>
        ...
        ?>
        <button class = "Button" onclick="window.location.href='vehicleForm.php'">Add Vehicle
        </main> 
