...
$result=$mysqli->query("select * from maintenancejob");
...
?>
    ...
    <main>
        ...
        <!-- Create table heading -->
            ...
            <?php
                while ($row=mysqli_fetch_array($result)){ 
                    echo "<tr><td>$row[maint_job_id]</td>";
                    echo "<td>$row[service_type]</td>";
                    echo "<td>$row[service_price]</td>";
                    echo "<td>$row[contradictions]</td>";
                    echo "<td>$row[date_of_job]</td>";
                    echo "<td>$row[total_cost]</td>";
                    echo "<td>$row[description]</td>";
                    echo "<td><a href='edit_tasks_maintenance.php?maint_job_id=$row[maint_job_id]'>Edit</a></td>";
                    echo "<td><a href='delete_tasks_maintenance.php?maint_job_id=$row[maint_job_id]'>Delete</a></td><tr>";
                } 
            ?>
        ...
        <?php
            $query = "SELECT * FROM maintenancejob";
        ...
        ?>
        <button class = "Button" onclick="window.location.href='tasksMaintForm.php'">Add Job
        </main> 
