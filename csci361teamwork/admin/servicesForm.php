...
<body>
    ...
    <main>
        <form method="post" action="add_route.php">
            <input type="date" id="date_of_route" name="date_of_route" placeholder="Date of Route"> <br>
            <input type="text" id="current_location" name="current_location" placeholder="Current Location"> <br>
            <input type="text" id="start_location" name="start_location" placeholder="Start Location"> <br>
            <input type="text" id="end_location" name="end_location" placeholder="End Location"> <br>
            <select id="status_of_route" name="status_of_route" placeholder="Status of Route">
                <option class="black" value="Active">Active</option>
                <option class="black" value="Delayed">Delayed</option>
                <option class="black" value="Cancelled">Cancelled</option>
                <option class="black" value="Completed">Completed</option>
            </select> <br>
            <input type="number" id="driver_id" name="driver_id" placeholder="Driver ID"> <br>
            <button class="Button">Add Route
        </form>
