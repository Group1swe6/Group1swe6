...
<body> 
    ...
    <form method="post" action="edit_driver_process.php">
            <input type="hidden" name="driver_id" value="<?=$row['driver_id']?>">
                ...
                <p3 style="color:white; text-align: center; width:50%;">Gov.ID:</p3> <input type="text" name="government_id" value="<?=$row['government_id']?>" required>
                <p3 style="color:white; text-align: center; width:50%;">Name:</p3> <input type="text" name="username" value="<?=$row['name']?>" required>
                <p3 style="color:white; text-align: center; width:50%;">Surname:</p3> <input type="text" name="surname" value="<?=$row['surname']?>" required>
                <p3 style="color:white; text-align: center; width:50%;">Midname:</p3> <input type="text" name="middle_name" value="<?=$row['middle_name']?>" required>
                <p3 style="color:white; text-align: center; width:50%;">Phone:</p3> <input type="text" name="phone" value="<?=$row['phone']?>" required>
                <p3 style="color:white; text-align: center; width:50%;">Email:</p3> <input type="email" name="email" value="<?=$row['email']?>" required>
                <p3 style="color:white; text-align: center; width:50%;">Code:</p3> <input type="number" name="driving_license_code" value="<?=$row['driving_license_code']?>" required>
                <p3 style="color:white; text-align: center; width:50%;">Driver Job:</p3> <input type="text" name="job" value="<?=$row['job']?>" required>
                <p3 style="color:white; text-align: center; width:50%;">Address:</p3> <input type="text" name="adress" value="<?=$row['address']?>" required>
